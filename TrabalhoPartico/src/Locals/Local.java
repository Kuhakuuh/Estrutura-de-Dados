...
/**
 * Class that represents a Local Local atributs: id: identifier of the local
 * longitude: longitude coordinate latitude: latitude coordinate energyAmount:
 * max of energy hold by the portal
 *
